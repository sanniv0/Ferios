      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              Beautiful, animated React components for building stunning user interfaces.
            </p>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            &copy; 2026 Ferios. All rights reserved.
          </p>
          <p className="built-with">
            Built with <span className="heart">❤</span> using three.js
          </p>
        </div>
      </div>
    </footer>
